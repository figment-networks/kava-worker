...
func main() {
	...
	if cfg.RollbarServerRoot == "" {
		cfg.RollbarServerRoot = "github.com/figment-networks/kava-worker"
	}
	...
	c := connectivity.NewWorkerConnections(workerRunID.String(), hostname+":"+cfg.Port, "kava", cfg.ChainID, "0.0.1")
